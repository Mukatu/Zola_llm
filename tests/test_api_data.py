...
def test_crm_analyze(client) -> None:  # type: ignore[no-untyped-def]
    payload = {
        "opportunities": [
            {"id_externe": "O1", "client": "ACME", "libelle": "Deal A", "montant_xaf": "1000000", "etape": "prospection"},
            {"id_externe": "O2", "client": "ACME", "libelle": "Deal B", "montant_xaf": "2000000", "etape": "negociation"},
            {"id_externe": "O3", "client": "ACME", "libelle": "Deal C", "montant_xaf": "3000000", "etape": "gagnee"},
        ],
        "quotes": [],
    }
...
def test_bi_kpis(client) -> None:  # type: ignore[no-untyped-def]
    payload = {
        "invoices": [
            {"id_externe": "I1", "numero": "F1", "sens": "vente", "tiers": "X",
             "date_emission": "2026-01-01", "montant_ht_xaf": "1000", "montant_ttc_xaf": "1180"},
        ],
        "employees": [
...
def test_finance_analyze(client) -> None:  # type: ignore[no-untyped-def]
    payload = {
        "transactions": [
            {"id_externe": "T1", "date_operation": "2026-01-10", "libelle": "Loyer", "montant_xaf": "200000", "sens": "debit"},
            {"id_externe": "T2", "date_operation": "2026-01-10", "libelle": "Loyer", "montant_xaf": "200000", "sens": "debit"},
            {"id_externe": "T3", "date_operation": "2026-01-11", "libelle": "Gros achat", "montant_xaf": "1500000", "sens": "debit"},
        ],
        "invoices": [],
