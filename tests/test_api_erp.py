...
def test_payroll_compute_requires_validation(client) -> None:  # type: ignore[no-untyped-def]
    ...
    r2 = client.post(
        "/v1/erp/payroll/compute", json={"brut_mensuel_xaf": "150000", "allow_unvalidated": True}
    )
    ...
    payload = {
        "offres": [
            ...
            },
            {
                ...
                "fournisseur": "Beta",
                "objet": "x",
                "montant_ht_xaf": "800000",
                "montant_ttc_xaf": "800000",
