...
| 2 | Finance / Trésorerie | ✅ | ✅ persisté (3 strates) | ✅ `store_bank_accounts`+`store_cash_flows` + factures | **Position consolidée**, gouvernance décaissements (2 niveaux), rapprochement bancaire, **prévisionnel/DSO/DPO/BFR/runway** + export | multi-devise avancé, scénarios |
...
| 7 | Paie | ✅ | ✅ persisté | ✅ `store_payslips` (PAIE-1) | **Bulletins historisés** (CNSS/IRPP), pilotage masse salariale, **agrégation annuelle DAS 1 / état annuel** + export formulaire (PAIE-3) | bulletin PDF, CMVD/enfants pour DAS1 |
