...
| 5 | Achats / Procurement | ✅ | ✅ | ✅ `store_suppliers`+`store_purchase_orders` (P2c-1) | Registre fournisseurs noté, historique BC, **réception→facture d'achat** | écran rebranché (P2c-2) |
