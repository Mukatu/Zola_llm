...
| 7 | Paie | ✅ | ✅ persisté | ✅ `store_payslips` (PAIE-1) | **Bulletins historisés** (CNSS/IRPP), upsert par période, **pilotage masse salariale** + coût employeur | bulletin PDF, DTS/déclarations |
