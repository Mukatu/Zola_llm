...
CIM-10 (OMS, libre), LNME (DPML), **conventions collectives sectorielles** par branche (pétrole/gaz, BTP, commerce — extraction PDF), barèmes **CNSS** + **CIPRES** (prévoyance), Code des marchés publics (ARMP).
