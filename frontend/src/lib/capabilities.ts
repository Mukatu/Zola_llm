...
export const CAPABILITIES: Record<string, Capability> = Object.fromEntries(
  [
    ...
    cap("erp.developpement", "Développement RH", GraduationCap,
      "Formation (catalogue, sessions, inscriptions) + indicateurs.",
      intents(["formation", "Formation"], ["indicateurs", "Indicateurs"]), "flagship"),
    ...
    cap("grc.conformite", "Conformité GRC", ShieldCheck,
      "Registre de conformité déterministe : obligations, contrôles, constats et plan de contrôle.",
      intents(["audit", "Audit"], ["controle", "Contrôle"]), "flagship"),
